  ...
  const renderContent = () => {
    return (
      <div
        ...
        className={clsx(
          'sidebar bg-[#fafafc] lg:border-e lg:border-e-gray-200 dark:border-e-coal-100 lg:fixed lg:top-0 lg:bottom-0 lg:z-20 lg:flex flex-col items-stretch shrink-0',
          themeClass
        )}
      >
