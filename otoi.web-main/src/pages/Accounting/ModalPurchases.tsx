...
const ModalPurchase = ({ open, onOpenChange, purchase_entry, onSuccess }: IModalPurchaseProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[calc(100%-2rem)] max-w-[500px] p-0 rounded-lg shadow-lg">
        ...
        <DialogBody className="p-3 sm:p-6">
          ...
          >
            ...
            <div className="flex items-center gap-2">
              <label htmlFor="entered_bill_checkbox" className="text-xs sm:text-sm font-medium text-gray-700">
                Entered Bill
              </label>
              <input
                type="checkbox"
            ...
            {/* Footer buttons */}
            <div className="flex justify-end pt-3 sm:pt-4 gap-2">
              <button
                type="button"
                onClick={() => onOpenChange(false)}
                className="inline-flex items-center justify-center rounded-md text-xs sm:text-sm font-medium bg-gray-100 text-gray-800 border hover:bg-gray-200 h-8 sm:h-10 px-3 sm:px-4 py-1.5 sm:py-2"
              >
                Cancel
              </button>
              <button
                type="submit"
                className="inline-flex items-center justify-center rounded-md text-xs sm:text-sm font-medium bg-blue-600 text-white hover:bg-blue-500 h-8 sm:h-10 px-3 sm:px-4 py-1.5 sm:py-2"
